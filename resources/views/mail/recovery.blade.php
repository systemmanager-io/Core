...
<div class="z" style="background-color:#edf2f7;align-items:center;justify-content:center;height:100%;width:100%">
    <div style="display:flex;align-items:center;justify-content:center;height:100%;margin-left:auto;margin-right:auto">
        <div align="center" class="eq m e p" style="border-radius:4px">
            <div
                style="background-color:#fff;box-shadow:0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -1px rgba(0,0,0,.06)">
                <div style="background-color:#1a202c;padding:64px;text-align:center"><h1
                        style="margin:0;padding:0;color:#2f855a;font-size:48px">RECOVERY</h1>
                ...
                <div style="padding-left:16px;padding-right:16px;padding-top:32px;padding-bottom:32px"><p>Hey {name}!<br><br>The
                        following server came back online<br></p>
                    <h1>{{ $serverName }}</h1>The server has successfully recovered!
                    <p></p></div>
            </div>
        </div>
    </div>
