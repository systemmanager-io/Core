    ...
    <div style="display:flex;align-items:center;justify-content:center;height:100%;margin-left:auto;margin-right:auto">
        <div align="center" class="e m pz p" style="border-radius:4px;align-items:center;justify-content:center">
            <div
                ...
                <div
                    style="background-color:#1a202c;align-items:center;justify-content:center;padding:64px;text-align:center">
                    <h1 style="margin:0;padding:0;color:#2b6cb0;font-size:48px">MESSAGE</h1>
                ...
                <a class="t p"
                   href="{{ $panelUrl }}"
                   style="background-color:#c53030;border-radius:4px;padding-top:12px;padding-bottom:12px;padding-left:16px;padding-right:16px;color:#fff">OPEN
                    SYSTEMMANAGER</a>
                <div style="padding-left:16px;padding-right:16px;padding-top:32px;padding-bottom:32px"><p>Hey
                        {name}!<br><br>The following server reported something<br></p>
                    <h1>{{ $serverName }}1</h1>You might want to take action<br>
                    <p></p></div>
            </div>
        </div>
    </div>
